...
export const EventDetailItem = ({ icon, alt, label }: { icon: string, alt: string, label: string }) => {
    return (
...
const EventDetails = async ({ params }: { params: Promise<string> }) => {
    ...
    const similarEvents: EventProps[] = await getSimilarEventsBySlug(slug)
        ...
        <section id={"event"}>
            ...
            <div className={"flex w-full flex-col gap-4 pt-20"}>
                ...
                <div className={"events"}>
                    {similarEvents.length > 0 && similarEvents.map((similarEvent: EventProps) => (
